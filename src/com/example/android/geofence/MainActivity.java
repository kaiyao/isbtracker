...
public class MainActivity extends FragmentActivity {
    private static final float GEOFENCE_DEFAULT_RADIUS = 100;
	/*
     ...
     */
    public void onRegisterNusStopsClicked(View view) {
        ...
        try {
			InputStreamReader is = new InputStreamReader(getAssets().open("NUS Bus Stops.csv"));
        ...
        try {
            ...
            mGeofenceRequester.addGeofences(mCurrentGeofences);
            Toast.makeText(this, "Geofences added",
                    Toast.LENGTH_LONG).show();
        } catch (UnsupportedOperationException e) {
            // Notify user that previous request hasn't finished.
